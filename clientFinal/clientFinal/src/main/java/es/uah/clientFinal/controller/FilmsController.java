...
public class FilmsController {
    ...
    public String addFilmReview(Model model, @PathVariable("id") Integer id) {

        Review review = new Review();
        Film film = filmsService.findFilmById(id);
        review.setIdFilm(id);
        model.addAttribute("title", "Add new review to film:"+film.getTitle());
    ...
    public String deleteFilmAndReviews(Model model, @PathVariable("id") Integer id, RedirectAttributes attributes) {
        // deletes Film and all the reviews from users
        Film film = filmsService.findFilmById(id);
